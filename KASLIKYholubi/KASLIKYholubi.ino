...
void loop() {
  ...
  if(currentMillis - previousMillis2 > interval2) {
    interval2 = basinterval + int(random(nahoda));
 ...
 if(currentMillis - previousMillis3 > interval3) {
    interval3 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis4 > interval4) {
    interval4 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis5 > interval5) {
   interval5 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis6 > interval6) {
   interval6 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis7 > interval7) {
   interval7 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis8 > interval8) {
   interval8 = basinterval +int(random(nahoda));
 ...
 if(currentMillis - previousMillis9 > interval9) {
   interval9 = basinterval +int(random(nahoda));
